...
TOKEN = '7968073538:AAHV2vRwyfMYIY877O-hhiOlPxdtiHNk3Eg'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002419195364
CHANNEL_ID = -1002419195364
error_channel_id = -1002419195364
...
def show_all_users(message):
    ...
    if user_id in admin_id:
        ...
        response = "🚫 Unauthorized Access! 🚫\n\nApne Baap Se Buy Kar Le Maadhrchod🙃.                        DM TO BUY:- @KalkiGamesYT.   @Masiha_Owner"
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/setupchannelkalki/4*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Dm :- @KalkiGamesYT*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Dm :- @KalkiGamesYT*", parse_mode='Markdown')
        elif message.text == "All Users":
        bot.reply_to(message, "*Authorised Users Lists.*", parse_mode='Markdown')
    else:
